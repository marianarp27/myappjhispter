...
To build the final jar and optimize the jhipsterapp001 application for production, run:
...
Then navigate to [http://localhost:50535](http://localhost:50535) in your browser.
